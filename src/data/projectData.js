// =============================================================================
// GETEILTE PROJEKTDATEN — identisch in allen Showcase-Portfolios.
// Beim Nachziehen einfach diese Datei kopieren + die referenzierten Bilder
// nach `public/projects/` legen. Pro Seite wird nur ./portfolioConfig.js
// angepasst (welches Portfolio die aktuelle Seite selbst ist).
//
// Bilder: Public-URL-Strings (`/projects/x.png`) -> funktionieren framework-
// unabhängig (Astro, React, Alpine) mit simplem <img src>. Keine Imports,
// keine imgMap nötig.
// =============================================================================
import CURRENT_PORTFOLIO from "./portfolioConfig.js";
...
const rawProjects = [
  ...
  },
  {
    ...
    title: "Portfolio v1",
    key: "v1",
    description: "Meine erste Haupt-Portfolio-Website mit Fokus auf Performance und klarem Design.",
    image: "/projects/portfolio1.png",
    technologies: ["Astro", "Tailwind", "JavaScript"],
    modalDescriptionDe: "Meine erste Haupt-Portfolio-Website. Entwickelt mit Astro für maximale Performance und Tailwind CSS für ein modernes, responsives Design. Der Fokus liegt auf einer klaren Präsentation meiner Projekte und Fähigkeiten sowie einer schnellen Ladezeit.",
    modalDescriptionEn: "My first main portfolio website. Developed with Astro for maximum performance and Tailwind CSS for a modern, responsive design. The focus is on a clear presentation of my projects and skills as well as fast loading times.",
...
// Markiert das Portfolio, das die aktuelle Seite selbst ist, mit "(Aktuell)".
export const projects = rawProjects.map((p) =>
  p.key && p.key === CURRENT_PORTFOLIO
    ? { ...p, title: `${p.title} (Aktuell)`, isCurrent: true }
    : p
);
